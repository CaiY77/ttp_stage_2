...
constructor(props) {
  ...
  render() {
    const { stocks, fetchStocks } = this.props
    return (<div>
      ...
      <Route exact path = '/' render={()=> <Portfolio stocks={stocks} fetchStocks={fetchStocks}/>}/>
      <Route path = '/transactions' render={()=> <Transaction stocks={stocks}/>}/>
